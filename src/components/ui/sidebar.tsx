    ...
    >
      ...
      >
        <div
          ...
          className='flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-xs group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-foreground/[0.07] dark:group-data-[variant=floating]:ring-foreground/10'
        >
          {children}
        </div>
      </div>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-2xl md:peer-data-[variant=inset]:shadow-xs md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2',
        className
      )}
      {...props}
    />
